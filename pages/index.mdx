...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">바닐라코딩<br className='sm:block hidden'/></h1>
    <p className="subtitle">TDD로 시작하는 자바스크립트 기초<br className='sm:block hidden'/></p>
    ...
    <p className="subtitle">
      <Link className={styles.cta} href="/part1/what-is-javascript">시작하기<span>→</span></Link>
    </p>
