...
[![호이스팅](./assets/hoisting/search-result.png)](https://www.google.com/search?q=hoist&source=lnms&tbm=isch&sa=X&ved=2ahUKEwip3K70pN3-AhV8sVYBHbwwDTwQ_AUoAXoECAEQAw&biw=1706&bih=1304&dpr=1)
...
<Collapse>
  <Collapse.Panel header="스스로의 결론을 예측해보셨다면, 이 내용을 열어보세요.">
    <p>
      ...
      ![호이스팅 오류](./assets/hoisting/hoisting-error-1.png)
      ...
      ![호이스팅 오류](./assets/hoisting/hoisting-error-2.png)
