...
<Collapse>
  <Collapse.Panel header="[영상 설명] 위의 예시 코드는 이런 흐름으로 실행됩니다. 1분 정도 생각해보시고, 열어보세요.">
    <p>
      100% 동일한 코드는 아닙니다. 그리고 Sorry, 알러지 때문에 선글라스 비디오 필터를 사용했습니다.
      <br />
      <iframe src="https://player.vimeo.com/video/824318743?h=277a6bd757" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
    </p>
  </Collapse.Panel>
</Collapse>
...
- 이동시켜 실행한 함수가 종료되어 더 이상 실행 중인 자바스크립트가 없는 상태이고 콜백 큐 대기열에서 대기하고 있는 함수가 있가면, 대기열 가장 앞에 위치한 함수를 콜 스택으로 이동시켜 실행될 수 있도록 합니다.
...
<Collapse>
  <Collapse.Panel header="예시 코드에 대한 영상 설명">
    <p>
      ...
      <br />
      <iframe src="https://player.vimeo.com/video/824318757?h=15a739b310" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
    </p>
  </Collapse.Panel>
</Collapse>
...
우리는 앞으로 잠시 몇 주간은 우선 가장 원시적인 패턴인 1번, 콜백 패턴에 집중할 것입니다. 그리고 이 과정에서 제가 여러분께 부탁드리고 싶은 것은 2, 3번과 같은 현재 트렌드에 너무 연연하지 마시고, 우리의 진행 방향에 모든 것을 집중해주세요.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/8aGhZQkoFbQ?start=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
